...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    body: {
      'en':
        "There's a new Tax Center \u2014 tucked under Labs, full admins only \u2014 that turns a year of receipts and invoices into the numbers a tax return actually needs. Your everyday categories stay exactly as they are \u2014 the tax lines live in their own separate list you can rename, hide, or add to. Match each category to a line once on the Mapping tab and every expense sorts itself from then on \u2014 the Schedule E tab then shows a property-by-property breakdown you can hand straight to your accountant. A Capital Review tab collects the bigger jobs and asks one question about each: was this a repair you deduct now, or an improvement you write off over time? It pre-fills a suggested answer and explains its reasoning, but the final call is always yours. The 1099-NEC tab tracks what you've paid each contractor this year and hands you a ready-made W-9 worksheet to give your accountant \u2014 pre-filled with who was paid what, and left blank where they collect the rest. There's nothing to set up and nothing to fill in: payments made by credit card are set aside automatically since the card processor already reports those, and the tab simply tells you the assumptions it made rather than asking you to enter them. Nothing about your contractors is stored beyond the payments themselves \u2014 no names, no tax ID numbers, no W-9 files.",
      'pt-BR':
        "H\u00e1 uma nova Central Fiscal \u2014 dentro de Labs, s\u00f3 para administradores completos \u2014 que transforma um ano de recibos e notas nos n\u00fameros que a declara\u00e7\u00e3o realmente precisa. Suas categorias do dia a dia continuam exatamente como est\u00e3o \u2014 as linhas fiscais ficam em uma lista pr\u00f3pria que voc\u00ea pode renomear, ocultar ou ampliar. Ligue cada categoria a uma linha uma vez na aba Mapeamento e todas as despesas passam a se organizar sozinhas \u2014 a aba Schedule E mostra ent\u00e3o um detalhamento por propriedade que voc\u00ea pode entregar direto ao seu contador. A aba Revis\u00e3o de Capital re\u00fane os servi\u00e7os maiores e faz uma pergunta sobre cada um: foi um reparo que voc\u00ea deduz agora ou uma melhoria que se deprecia ao longo do tempo? Ela j\u00e1 sugere uma resposta e explica o motivo, mas a decis\u00e3o final \u00e9 sempre sua. A aba 1099-NEC acompanha quanto voc\u00ea pagou a cada prestador no ano e entrega uma planilha W-9 pronta para dar ao seu contador \u2014 j\u00e1 preenchida com quem recebeu quanto, e em branco onde ele coleta o resto. N\u00e3o h\u00e1 nada para configurar nem preencher: pagamentos no cart\u00e3o s\u00e3o separados automaticamente, j\u00e1 que a operadora do cart\u00e3o j\u00e1 os declara, e a aba simplesmente informa as suposi\u00e7\u00f5es que fez em vez de pedir que voc\u00ea as digite. Nada sobre seus prestadores \u00e9 guardado al\u00e9m dos pr\u00f3prios pagamentos \u2014 sem nomes, sem n\u00fameros fiscais, sem arquivos de W-9.",
    },
  },
  {
    id: 'v13.14',
