...
import { BarChart3, Home, Tag, LogOut, FileText, AlertCircle, Users } from 'lucide-react';
...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-100">
      <aside className="w-64 bg-gradient-to-b from-emerald-900 to-emerald-950 flex flex-col shrink-0">
