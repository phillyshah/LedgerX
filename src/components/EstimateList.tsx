    ...
    <>
      {onAdd && (
        <div className="flex justify-end mb-3">
          <button
            onClick={onAdd}
            className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-900 hover:bg-emerald-800 text-white rounded-xl transition-all shadow-sm text-sm font-medium active:scale-[0.98]"
          >
            <Plus className="w-4 h-4" />
            {t('estimate.emptyCta')}
          </button>
