...
- **Version bump**: Every set of changes merged to main MUST increment the version by `0.1` in both `src/components/AuthForm.tsx` AND `package.json`. Current version: `v4.3`. Example: `3.5` → `3.6` on the next change.
