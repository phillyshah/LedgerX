...
- **Version bump**: Every set of changes merged to main MUST increment the version by `0.1` in both `src/components/AuthForm.tsx` AND `package.json`. Current version: `v3.4`. Example: `3.4` → `3.5` on the next change.
